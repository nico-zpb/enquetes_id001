                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <?php foreach($numCentreByMonthPercent as $k=>$v): ?>
                            <td><?php echo $v; ?>%</td>
                        <?php endforeach; ?>
                        <td><?php echo round(($totalCentre/$totalOriginEntry) * 100); ?>%</td>
                    </tr>
                    <tr>
                        ...
                        <?php foreach($numParisByMonthPercent as $k=>$v): ?>
                            <td><?php echo $v; ?>%</td>
                        <?php endforeach; ?>
                        <td><?php echo round(($totalParis/$totalOriginEntry) * 100);  ?>%</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php foreach($numEtrangerByMonthPercent as $k=>$v): ?>
                            <td><?php echo $v; ?>%</td>
                        <?php endforeach; ?>
                        <td><?php echo round(($totalEtranger/$totalOriginEntry) * 100);  ?>%</td>
                    </tr>
                    <tr>
                        <td>Total</td>
                        <?php foreach($ClientsByMonth as $name=>$v): ?>
